class MazeBuilder {
    ...
    constructor(width, height) {
        ...
        /*
            Creates a wall at the top and bottom of the array and then adds additional, alternating
            wall blocks in the middle of the grid area
         */
        ...
        // partition the existing walls starting in the second row / second column
    ...
    /*
        Decides whether the top, left, right or bottom grid reference from the current position should show a wall or not by randomly
        swapping the values true, true, true and false passed into it
    */
    ...
    /*
        Recursively splits each grid into four smaller grids randomly (ish) until the value r1 is greater than r2 OR
        c1 is greater than c2. Te initial r1 value is set to 1 (second row of the array), c1 is also set to 1 (second column of the array)
    */
    ...
    partition(r1,r2,c1,c2){
        ...
        if(r1 === r2){
            horiz = r1; // sets the vertical split to the current row
        }else{
            x = r1 + 1; // x coordinate
            y = r2 - 1; // y coordinate
        ...
        // creates new partitions within each of the previous partitions
    ...
    placeMonster() {
        ...
        let fr, fc;
        [fr, fc] = this.getMonsterLocation();

        this.maze[fr][fc] = ["monster"];
